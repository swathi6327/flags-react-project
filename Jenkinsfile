pipeline {
    ...
    environment {
        ...
        SERVER_HOST = '172.31.14.238'    // Hostname or IP address of the server
        SSH_KEY = credentials('master-ssh') // Jenkins credentials for SSH key
    }
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git url: 'https://github.com/swathi6327/flags-react-project.git', branch: 'master'
            }
        }
